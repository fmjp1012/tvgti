...
r_pp: int = 30       # window size
q_pp: int = 20       # number of processors
rho_pp: float = 2.48    # 試行回数の設定
mu_lambda_pp: float = 1

# Proposed_nonoverlap 手法用パラメータ
r_pp_nonoverlap: int = 30       # window size
q_pp_nonoverlap: int = 20       # number of processors
rho_pp_nonoverlap: float = 2.48    # 試行回数の設定
