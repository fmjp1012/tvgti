...
lambda_reg_pc = 0.1
lambda_reg_co = 0.1
lambda_reg_sgd = 0.0436
alpha: float = 0.02
beta_pc: float = 0.02
beta_co: float = 0.02
beta_sgd: float = 0.00124
...
# モデルのインスタンス化
tv_sem_pc = TimeVaryingSEM_PC_SPARSE(N, S_0, lambda_reg_pc, alpha, beta_pc, gamma, P, C, name="pc")
tv_sem_co = TimeVaryingSEM_PC_SPARSE(N, S_0, lambda_reg_co, alpha, beta_co, gamma, 0, C, name="co")
tv_sem_sgd = TimeVaryingSEM_PC_SPARSE(N, S_0, lambda_reg_sgd, alpha, beta_sgd, 0, 0, C, name="sgd")
...
filename: str = (
    ...
    f'C{C}_'
    f'gammma{gamma}_'
    f'reg_pc{lambda_reg_pc}_'
    f'co{lambda_reg_co}_'
    f'sgd{lambda_reg_sgd}_'
    f'alpha{alpha}_'
    f'betapc{beta_pc}_'
    f'co{beta_co}_'
    f'sgd{beta_sgd}_'
