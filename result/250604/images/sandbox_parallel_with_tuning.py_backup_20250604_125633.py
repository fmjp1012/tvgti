...
tuning_suffix = "_tuned" if (run_pp_flag and enable_hyperparameter_tuning) else ""
...
if run_pp_flag and enable_hyperparameter_tuning:
    tuning_results = {
        'timestamp': timestamp,
        'optimized_rho': optimized_rho,
        'optimized_mu_lambda': optimized_mu_lambda,
        'n_trials': n_tuning_trials,
        'final_nse': error_pp[-1] if error_pp else None
    }
