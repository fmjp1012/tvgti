...
q_fixed = 1                           # qは固定
rho_list_r = [0.015, 0.0793, 0.134, 0.237, 1.034]
mu_lambda_list_r = [0.00857, 0.33, 0.0867, 0.041, 0.0154]

# Proposed手法（qを変化させる場合）のパラメータ
q_list = [1, 2, 4, 8, 40]
r_fixed = 1
rho_list_q = [0.015, 0.0297, 0.0321, 0.0281, 0.069]
mu_lambda_list_q = [0.00857, 0.0305, 0.0264, 0.00939, 1.202]
