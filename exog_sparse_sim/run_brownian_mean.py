...
from exog_sparse_sim.data_gen import generate_brownian_piecewise_Y_with_exog
...
def main():
    ...
    filename = (f'timestamp{timestamp}_result_N{N}_notebook_filename{notebook_filename}_'
                f'num_trials{num_trials}_T{T}_K{K}_stdS{std_S}_seed{seed}_r{r}_q{q}_rho{rho}_mulambda{mu_lambda}.png')
    print(filename)
